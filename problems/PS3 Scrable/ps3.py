...
#    pass  # TO DO... Remove this line when you implement this function
    ...
    word_score = 0
    for i in freq:
        word_score += freq[i] * SCRABBLE_LETTER_VALUES[i]
    second_comp = max((7*len(word) - 3 * (n-len(word))), 1)
    return word_score * second_comp
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while len(hand) > 0:
        print("\nCurrent Hand: ", end=''); display_hand(hand)
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            if is_valid_word(user_input,hand,word_list):
                ...
                print('"'+str(user_input)+'" earned',get_word_score(user_input,calculate_handlen(hand)),'points. Total:', score,'points')
                print()
            ...
            # Otherwise (the word is not valid):
                ...
                print('That is not a valid word. Please choose another word. You are punished still')
                print()
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    t_n_hands = int(input('Enter total number of hands: '))
    total_score = 0
    check_sub = True
    check_replay = True

    for i in range(t_n_hands):
        ...
        hand1 = play_hand(hand,word_list)

        if check_replay:
            rep = input("\nWould you like to replay the hand? ")
            if rep == "yes":
                hand2 = play_hand(hand,word_list)
                check_replay = False

        total_score += max(hand1, hand2)
    print('Total score for the whole game:', total_score)
